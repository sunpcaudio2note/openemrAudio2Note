...
try {
    ...
    $transcriptionServiceClient = new TranscriptionServiceClient(); // Constructor loads config

    // 3. Call getTranscriptionStatus
    $serviceResponse = $transcriptionServiceClient->getTranscriptionStatus($jobId);
    ...
    switch ($serviceStatus) {
        case 'completed':
            ...
            $transcriptionServiceClient->purgeJobData($jobId);
            break;
