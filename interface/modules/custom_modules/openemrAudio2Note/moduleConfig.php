...
/**
 * OpenEMR Audio2Note Integration module configuration file.
 */
...
// Include the OpenEMR bootstrap file to ensure all necessary classes are loaded.
require_once __DIR__ . '/openemr.bootstrap.php';
